...
class MechatronicsEngineer:
    ...
    def current_focus(self):
        return {
            "🎓 Studies": "Advanced Control Systems & Robotics",
            "🔬 Research": "Quantum Computing (Internship May 2026)",
            "💡 Interests": ["Dynamic Systems", "ML", "Signal Processing"],
            "🤖 Projects": "ROS2, Embedded Systems, Web Integration"
        }
    
    def expertise(self):
        return [
            "System Identification & Digital Control (PID/RST)",
            "Signal Processing & Feature Engineering",
            "CNN/LSTM Pipelines for Time-Series",
            "Robotics: ROS 2 + Gazebo Simulation",
            "Embedded-to-Web Integration"
        ]
```
...
<img src="https://img.icons8.com/fluency/96/000000/control-panel.png" width="60"/><br/>
<b>Control & Modeling</b><br/>
System ID, Digital Control<br/>
PID/RST, Thermodynamics
</td>
<td align="center" width="33%">
<img src="https://img.icons8.com/fluency/96/000000/artificial-intelligence.png" width="60"/><br/>
<b>ML & Signal Processing</b><br/>
Time-Series Analysis<br/>
CNN/LSTM, Feature Engineering
</td>
<td align="center" width="33%">
<img src="https://img.icons8.com/fluency/96/000000/robot-2.png" width="60"/><br/>
<b>Robotics & Embedded</b><br/>
ROS 2, Gazebo, Kinematics<br/>
Embedded-to-Web Interfaces
</td>
</tr>
</table>
...
![Gazebo](https://img.shields.io/badge/Gazebo-orange?style=for-the-badge&logo=robotframework&logoColor=white)
...
![MPI](https://img.shields.io/badge/MPI-Parallel-blue?style=for-the-badge)
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=2600&pause=700&color=00D9FF&center=true&vCenter=true&width=950&lines=Focused+on+high-impact+work+in+Control%2C+Robotics%2C+and+Machine+Learning;Targeting+a+Quantum+Computing+Internship+%28May+2026%29" alt="Current goals typing" />
...
- **Quantum Computing** (Target: May 2026)
